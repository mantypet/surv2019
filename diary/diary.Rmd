...
The generalisation of this problem is covered in measure theory, more specifically Lebesque's Dominated Convergence Theorem, which was not very helpful in increasing my understanding of the issue. What I was able to gather, and I hope I'm not too far off, if the integral is fairly well-behaved, as in being finite and the function itself being continuous, the limits and the integral are interchangable.

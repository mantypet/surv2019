...
library("tidyverse");library(ggplot2);library(survival);library(broom);library(eha); library(tinytex); library(survminer)
...
```{r}
v <- c(1849/365.25, 123/365.25, 5354/365.25)
names(v) <- c("Median", "Lower", "Upper")
v
```
